...
> 나는 학생들을 가르치지 않는다. 다만 학생들이 배울 수 있는 환경을 제공해 주려고 애쓸 뿐이다.
...
- 청중에게 놀랑무을 안겨주라
- 인지 부조화의 상황을 연출하라
  - 둘 다 옳고 믿는 두 가지 의견을 들었을 때 느끼는 불편한 감정
...
> 청중이 듣는 것을 끝내기 전에 연설을 먼저 끝내야 합니다.
...
> 동기부여는 사람들에게 시키고 싶은 일을 자기가 하고 싶어서 하게 만드는 예술이다.
...
```
나도 가끔 슬플 때 신라면을 먹는다. 요리할힘이 없어서 그렇기도 하지만 그냥 평소에 자주 먹는 신라면만큼은 어떻게든 꾸역꾸역 먹게된다.
```
...
81. 사람들은 자기와 비슷하거나 매력적인 사람의 말에 귀 기울이고 설득당한다.

- 중뇌는 당신이 믿을 만하고 친구가 될 수 있을지를(자기와 비슷한지를 무의식적으로 평가하면서)
- 구뇌는 당신이 섹스파트너가 될 가능성이 있는지, 같은 방에 있어도 될 만큼 안전한 환경인지를 판단한다.
- 비슷할수록 좋다. 자기와 비슷한 옷차림의 사람을 좋아한다.
- 캐나다 선거에서 73퍼센트의 투표자가 매력이 투표에 영향을 주지 않는다고 말했지만 매력적인 후보자가 2.5배 더 많이 특표했다는 사실을 발견했다.

```
예전에 역사 강의를 들을 때 특정 대통령은 잘생겨서 당선되었다는 얘기를 들은적이 있다. 그리고 내 세대에서도 비슷한 경험을 한적이 있다. 뭐 어쩔수없다.. 본능인걸 어쩌겠는가.. 어쩌면 나도 그런 사람일지도 모른다.
예전에 대학교 수업이였나? 그때 교수님이 흰코트입고 발표한 친구가 멋있어보이고 다들 잘 들었다고 말한적이 있다. 아마 이것도 이와 유사한 것 같다. 나는 그동안 크게 신경쓰지 않았는데.. 소개팅나간다고 생각하고 옷을 입어야겠다.
개발자들에게 하는 발표는 검정무지티에 청바지를 입는게 괜찮을지도 모르겠다?
```

82. 커뮤니케이션 하는 동안 말하는 사람의 두뇌와 듣는 사람의 두뇌가 연동된다.

83. 두뇌는 개인적으로 아는 사람에게 특유의 반응을 보인다.

- 사람들은 친구와 친척에게 특별한 관심을 기울이도록 '프로그램되어' 있다.
- 할 수 있다면, 프레젠테이션 전에 시간을 내서 청중들과 친분을 쌓아라.

```
유튜버가 처음에는 못생겨보였는데 나중에는 잘생겨보인다는 얘기를 들은적이 있다. 이것도 비슷한 케이스가 아닐까? 인성이나 성품이 좋아서 그런경우도 있겠지만 그게 아니더라도 영향이 있는 것 같다.
```

84. 사람들은 프리젠터가 발표회장을 통제하기를 바란다.

- 당신이 강하고 자신있는 모습을 보이면 사람들은 당신이 책임자라고 믿는다.
- 시작시간, 끝나는 시간을 지켜라.
- 허둥지둥 하지말고 자기 페이스 지켜라.
- 미리 정해진 시간에 휴식시간을 가져라.
- 가능하면 언제나 서서 하라.

# 사람들은 어떻게 행동하기로 결정할까

> 비즈니스에서 가장 훌륭한 능력은 남과 어울리고 남의 행동에 영향을 주는 것이다.

85. 사람들은 대부분의 결정을 무의식적으로한다.

- 무의식적인 의사결정은 다음과 같은 요소를 포함한다.
  - 다른 사람들이 가장 많이 쓰는 것: X 제품을 쓰는 사람들이 가장 많은 것 같아.
  - 자기 성향과 일치하는 것(관여): 나는 최신제품을 써 보는 사람이야.
  - 이번 구매로 의무 혹은 사회적 채무를 갚을 수 있는지(호혜): 저 판매자가 60일 무료 체험판과 무료 교육 및 지원을 해 줬어.
  - 상실의 두려움: 이 제품은 할인판매 중이야. 지금 사지 않으면 가격이 오를지 몰라.
  - 자신만의 특별한 충동, 동기, 두려움
- 사람들이 행동하도록 영향을 주려면 사람들의 무의식적 동기를 이해해야 한다.
- 사람들이 무의식적 요소에 근거해서 결정을 내리지만 그 결정에 대한 이성적이고 논리적인 이유를 원한다. 그러므로 이성적, 논리적인 이유를 제공해야한다.

```
참 웃기는 얘기다. 경력이 많아질수록 가치관은 확립되고 무의식이 강해진다. 그리고 이성적인척하지만 내면에는 이전의 경험들로 인한 무의식이 박혀있다. 사실 이게 잘못된 건 아니다. 경험이란건 현재 시점에서 이성적으로 판단하더라도 무엇이 더 좋다고 쉽게 판단할 수 없다. 블로그 글로도 쓴 주제인데 결국 겸손해야 이런 현실적인 문제들을 해결할 수 있다.
주제와 다르니 다시 넘어와보면.. 나는 상대방의 무의식을 공감하는 대화를 한적이 있는가? 생각해보게 된다. 어렴풋이 한 적은 있는 것 같다. 그리고 나도 이전 경험으로 인해 해당 방식을 고민하고 있다고 얘기한 적이 있다. 앞으로는 조금 더 이런 부분들에 대해 공감하면서 대화, 발표를 하려고 한다.
```

86. 상실의 두려움이 획득의 기대보다 크다.

- 무의식은 가장 먼저 위험을 고른다.(처음에는 오히려 위험한걸 선택하고, 점점 안정적인 걸로 변경한다.)
- 이미 가진 것을 읽을까봐 두려워함
  - 1. 풀옵션 자동차 보여주고 비싸다고 하자 옵션 하나씩 빼기
  - 2. 깡통 자동차 보여주고 옵션 선택하면 가격 추가된다고 하기.
  - 첫번째 조건에서 사람들은 더 많은 돈을 쓴다.
- 획득보다는 상실의 관점에서 메시지 만들기
  - 광고 대행사 변경하면 뭐가 더 좋다X 뭐를 읽는다O

87. 사람들은 자기가 실제 처리할 수 있는 것보다 더 많은 선택권과 정보를 원한다.

- 6가지 잼이 있는 테이블에 들렀던 사람들 중 31퍼센트가 구매했지만, 24가지 잼이 있는 테이블에 들렀던 사람들 중 구매한 사람은 겨우 3퍼센트다.
  - 24가지 잼: 100명 중 60명 방문. 2명만 구매.
  - 6가지 잼: 100명 중 40명 시식. 12명만 구매.
- 이것은 도파민 효과의 일부다. 정보는 중독성이 있다. 사람들은 자기 결정에 자신 있을 때만 정보 추구를 멈춘다.
- 사람들에게 요구하는 선택 경우의 수를 최대 3~4가지로 제한하라.
...
88. 사람들은 선택권이 통제력이라고 생각한다.

- 선택 가짓수를 제한하는 것이 좋긴 하지만 그래도 몇 가지 선택권을 제공해야 한다.
- 사람들은 자기가 통제하고 선택권이 있다는 느낌이 필요하다. 이건 어린 아이, 동물들도 가지고 마찬가지다.

89. 사람들은 돈보다 시간을 더 많이 걱정한다.

- 자전거 코스에서 "잠깐 시간을 내서 레모네이드를 즐기세요" vs "약간의 돈으로 레모네이드를 즐기세요" + 가격에 따라 좋은 품질의 컵 받기.
  - 시간을 언급했을 때 2배 많은 사람들이 샀다.
  - 돈을 언급했을 때 더 적은 돈을 지불했다.
- 단, 돈에 영향을 받는 청중들이라면 돈을 언급하라.
- 대부분의 사람은 대부분 돈이나 소유보다는 개인적 연결을 형성하는 시간과 경험에 더 많은 영향을 받는다.

```
처음에는 의외라고 생각했는데 조금 생각해보니 나도 공감을 했다. 내가 돈을 잘 안쓰는 사람이긴 한데, 항상 시간이 더 소중하다고 생각해왔다. 그리고 운동하다가 음료수라면 가격이 문제가 될 것 같기는 않다.
돈을 아껴줘요 vs 시간을 아껴줘요. 시간을 아껴준다는게 더 끌린다. 그리고 요즘 AI 활용해서 생산성을 올렸어요 어쩌구저쩌구 이런글이 많을 걸 보면 확실히 그렇다.
```

90. 기분은 설계 형성 과정에 영향을 준다.

- 평소에 직관적으로 결정을 내리는 참가자들은 직관적인 지시를 받았을 때 보온병의 가치를 더 높게 평가했다.
- 평소에 숙고해서 결정을 내리는 참가자들은 의도적인 지식를 받을 때 보온병의 가치를 더 높게 평가했다.
- 행복한 기분의 참가자들은 평소의 의사결정 스타일과 상관없이 직관적인 결정을 할 때 보온병의 가치를 더 높게 평가했다.
- 기분이 좋은 사람들은 첫 느낌으로 빨리 결정을 내리라고 할 때 제품의 가치를 더 높게 매긴다.
- 기분이 슬픈 사람들은 심사숙고하는 방식으로 결정하라고 할 때 제품의 가치를 더 높게 매긴다.

```
기억하면 언젠가 도움이 될 것 같다.
```

91. 집단 의사결정은 결함이 있을 수 있다.

- 최선의 판단을 하기 위해 참가자는 자기가 받은 모든 정보를 모두 살펴봐야 한다.
- 그룹이 초기 선호도를 공유하고 나서 토론을 시작하면 그룹의 선호도 외에 다른 유용한 정보에 시간과 주의를 더 적게 들인다. 그러므로 최적보다 못한 결정을 내리고 만다.
- 하지만 한 살마보다는 (유능한) 두 사람이 낫다.
- 프레젠테이션 때 좋은 의사결정을 하게 하는 방법
  - 청중들이 자세히 살펴볼 시간을 가질 수 있게 프레젠테이션 전에 청중들에게 미리 정보를 제공하라.
  - 프레젠테이션 진행 중에 청중들에게 결정을 내리도록 요청할거라면 미리 알려줘야 한다.
  - 사람들이 자기 결정에 대한 확신과 함께 자기 결정을 말할 수 있는 공간을 만들어 둬라.
  - 의사결정이 프레젠테이션의 일부라면 충분한 시간을 줘라. 최소한 3분의 1을 토론에 줘라.

```
나는 보통 챌린지하는 사람이다. 그래서 나는 보통 챌린지하지 않는데 확실히 그런 회의들이 많이 있는 것 같다.
```

92. 사람들은 우세한 사람에 흔들린다.

- 리더는 맨 처음으로 말한 사람들이었다. 그리고 지배적 성격을 가진 사람들은 언제나 맨 처음으로 말했다.
- 프레젠테이션의 통제권을 다시 돌려받을 생각이라면 절대 남에게 넘기지 마라. 통제권을 넘겨주기 전에 반드시 당신의 발표를 끝내고 나서, 다른 사람에게 발표 기회를 주어라.
- 지배력 있는 고위급 인사가 청중으로 조용히 앉아 있을 수 있는 시간은 기껏해야 5~10분이다.

```
나는 지배적인 성격을 가진 사람일까? 아무도 말하지 않는다면 내가 먼저 나서서 말한다. 그리고 할 말이 있다면 기회를 봐서 말한다. 이게 일상생활은 아니고 업무 관련 대화일 때만 그런 것 같다. 그래서 그런지 내향적인 성격이지만 작은 발표나 리더를 맡게 되는 경우가 종종 있었다.
```

93. 사람들은 확신이 없을 때, 다른 사람들이 대신 결정해주기를 바란다.

- 사람들은 남들이 행동할 때만 행동한다. ex) 화풍구에서 연기나도 다들 가만히 있으면 가만히 있는다.
- 문구 선정이 중요하다.
  - "2009년에 미국의 18세 이상 성인 중 20.8퍼센트가 흡연을 했습니다." 보다는
  - "2009년에 미국의 18세 이상 성인 중 79.4퍼센트가 흡연을 하지 않았습니다." 라고 말하는게 흡연하지 않는데 더 큰 영향력을 발휘한다.

94. 사람들은 남들이 자기보다 더 많이 영향받는다고 생각한다.

- "맞아요, 다른 사람들은 이런 것에 영향을 받아요. 하지만 나는 안 그래요." => 너도 그래요..
- 속이려고 속이는건 아니고 무의식적 과정에 의해 영향을 받아서 그렇다.
- 논리와 분석에 의해서만 결정하는 사람이라고 말하더라도 믿지 마라. 무의식적 요소에 호소하는 프레젠테이션도 좋다.

95. 사람들은 제품이 자기 눈앞에 있을 때 더 높게 평가한다.

- 텍스트, 그림, 견본, 투명유리, 실물 순으로 더 높은 금액으로 평가했다.
- 제품과 관련 있는 프레젠테이션을 한다면 실물을 가져가서 프레젠테이션 중에 보여주어라.
- 가능하다면 사람들이 제품을 만져볼 수 있게 하라.

96. 사람들은 변하지 않는 페르소나를 유지하고 싶어 한다.

- 페르소나: 심리학에서 타인에게 비치는 외적 성격
- 샤람들은 페르소나를 갖고 있고, 이 행동에 부합하는 행동을 하고 싶어 한다.
- 사람들이 행동하게 하고 싶다면 먼저 페르소나를 활성화시켜라.

```
모두에게는 각자의 사정이 있다.. 사소한 것 하나 하나라도..
```

97. 작은 걸음이 페르소나를 바꿀 수 있다.

- 지금 얘기하는 주제가 자기에게 중요하다는 걸 깨닫게 하라. 개인적이고 구체적인 단어를 써서 말하라. "이 소프트웨어는 왜 사용하기 힘들까요?"라고 묻지 말고, "최근에 사용법이 어려워서 쓰기 힘들었던 소프트웨어는 무엇입니까?"라고 물어라. 구체적으로 얘기해야 그 주제가 자기와 상관있는 것으로 인식한다.
- 새롭게 수정된 페르소나에 조금 더 가까워진 작은 행동을 취한 후에 더 큰 약속을 요구하라.

```
중간에 중요하다는걸 알려주는 실습은 정말 좋은 것 같다. 사람들은 내가 실제로 경험하지 않은것에 대해 간과하는 경향이 있다.
```

98. 손으로 쓰면 헌신이 증가한다.

- 기억과 헌신을 최대화하려면 키보드로 타이핑하지 말고 손으로 쓰게 하라.

```
나는 맨날 키보드만 쓰는데... 손으로 쓰는게 더 좋다는건 알고 있지만 현실적으로 어려움이 있다..
```

99. 사람들은 의무감을 줄이기 위해 행동한다.

- 이메일에 개개인의 주소 라벨을 붙여서 응답자가 '보답'해야 하는 의무감을 느끼게 했을 때 기부는 거의 2배가 되었다.
- 선물의 크기가 일치할 필요는 없다.
- 작은 증정푼, 펜, 형광펜, 사탕, 책자 등을 줘도 좋다.
- 프레젠테이션이 유용하다면 그것이 빚진 느낌을 유발하는 선물 역할을 할 수 있다.

100. 처음엔 거절해도 다음번엔 수락하는 경우가 많다.

- 당신이 무엇을 부탁했는데 상대가 거절한다면 상대는 빚진 느낌을 갖는다. 그래서 다음번에 당신이 더 작은 것을 부탁하면 들어줘야 한다고 생각하게 된다.
- 처음에 거절했다가 더 작은 부탁을 수락하면 헌신이 높아진다.
- 프레젠테이션 중간에 뭔가 큰 것을 요청할 방법을 만들어라. 그런 다음 프레젠테이션 끝의 행동 요청에서 더 작은 부탁을 하라.

---

# 프레젠테이션 작성 방법

프레젠테이션 1분을 준비하는 데 1시간이 걸린다.

## 1단계: 직접 조사하라

### 제1과제: 청중에 대해 아는 것과 짐작하는 것을 문서로 작성하라

- 짐작을 조심하라. 짐작이 틀린 경우가 많다.

### 제2과제: 회의 주선자의 목적과 청중의 목적을 문서로 작성하라

프레젠테이션을 마치고 사람들이 회의장을 떠날 때,

A) 그들은 자신에게 그리고 남들에게 뭐라고 말할까요?

B) 그들이 자기 업무 혹은 가정으로 돌아갔을 때 어떤 행동을 취할까요?

이렇게 질문하면 주최자에게 진짜 중요한 것에 대한 정보를 가장 잘 얻을 수 있다.

### 제3과제: 그들의 현재 위치와 희망 위치를 비교하라.

차이는 얼마나 큰지 알아야하고(취업 걱정하는 사람에게 자선단체 기부유도x), 합리적이면서도 도전할 만한 차이를 계획해야한다.

## 2단계: 프레젠테이션 작성하기

- 마법의 공식
  - 오프닝: 현재 상태, 결과, 해결책(이게 핵심이다. 1분내에 모두 끝내야한다.)
  - 본론: 현재 상태, 결과, 해결책
  - 클로징: 행동 촉구(선택의 가짓수는 4가지 넘지 않게)
